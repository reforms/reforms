 ...
 * -----------------------------------------
 * Рассмотреть варианты, когда:
 * 1) :id   - обязательный параметр и может быть NULL
 * 2) :id?  - не обязательный параметр
 * 3) :id!  - обязательный параметр и НЕ может быть NULL
 * 4) ::id  - не обязательный параметр
 *
 * @author evgenie
 */
